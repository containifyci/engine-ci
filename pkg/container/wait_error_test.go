...
func (m *MockContainerManagerForErrorTesting) CreateContainer(ctx context.Context, opts *types.ContainerConfig, authBase64 string) (string, error) {
	return "", nil
}
func (m *MockContainerManagerForErrorTesting) CommitContainer(ctx context.Context, containerID string, opts types.CommitOptions) (string, error) {
	return "", nil
}
func (m *MockContainerManagerForErrorTesting) RemoveContainer(ctx context.Context, containerID string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) ContainerList(ctx context.Context, all bool) ([]*types.Container, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) ContainerLogs(ctx context.Context, id string, ShowStdout bool, ShowStderr bool, Follow bool) (io.ReadCloser, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) CopyContentToContainer(ctx context.Context, id, content, dest string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) CopyDirectorToContainer(ctx context.Context, id, srcPath, dstPath string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) CopyToContainer(ctx context.Context, id, srcPath, dstPath string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) CopyFileFromContainer(ctx context.Context, id string, srcPath string) (string, error) {
	return "", nil
}
func (m *MockContainerManagerForErrorTesting) ExecContainer(ctx context.Context, id string, cmd []string, attachStdOut bool) (io.Reader, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) BuildImage(ctx context.Context, dockerfile []byte, imageName string, platform string) (io.ReadCloser, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) BuildMultiArchImage(ctx context.Context, dockerfile []byte, dockerCtx *bytes.Buffer, imageName string, platforms []string, authBase64 string) (io.ReadCloser, []string, error) {
	return nil, nil, nil
}
func (m *MockContainerManagerForErrorTesting) ListImage(ctx context.Context, image string) ([]string, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) PullImage(ctx context.Context, image string, authBase64 string, platform string) (io.ReadCloser, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) TagImage(ctx context.Context, source, target string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) PushImage(ctx context.Context, target string, authBase64 string) (io.ReadCloser, error) {
	return nil, nil
}
func (m *MockContainerManagerForErrorTesting) RemoveImage(ctx context.Context, target string) error {
	return nil
}
func (m *MockContainerManagerForErrorTesting) InspectImage(ctx context.Context, image string) (*types.ImageInfo, error) {
	return nil, nil
}
